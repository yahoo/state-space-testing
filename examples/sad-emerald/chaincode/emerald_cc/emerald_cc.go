//
// This work is derived from the file 'acxiom_cc.go' which is part of the IAB Tech Lab's "PrivacyChain"
// It is used here pursuant to the license grant established with the publication of that work.
// That license is the Apache-2.0 license, which is published at, at least, the following location:
//   https://github.com/InteractiveAdvertisingBureau/PrivacyChain/blob/master/LICENSE
//   https://git.state-space.dev/core/PrivacyChain/tree/LICENSE
//   https://git.state-space.dev/core/PrivacyChain/tree/LICENSE?h=series%2F00.worthy-cupboard
// 
// The work herein, including changes is available to you under license as follows:
// Copyright 2019, Oath Inc.
// This work is licensed to you under the terms of the Apache-2.0 license.
// See the LICENSE file at https://git.state-space.dev/examples/sad-emerald/tree//LICENSE
...
// EmeraldAsset implements a simple chaincode to manage an asset
type EmeraldAsset struct {
}

// Init is called during chaincode instantiation to initialize any
// data. Note that chaincode upgrade also calls this function to reset
// or to migrate data.
func (t *EmeraldAsset) Init(stub shim.ChaincodeStubInterface) peer.Response {
...
func (t *EmeraldAsset) Invoke(stub shim.ChaincodeStubInterface) peer.Response {
...
//获得到Match数据对应实际数据的列数
//Get the number of columns corresponding to the actual data of the Match data
...
func main() {
    if err := shim.Start(new(EmeraldAsset)); err != nil {
            fmt.Printf("Error starting EmeraldAsset chaincode: %s", err)
    }
}
